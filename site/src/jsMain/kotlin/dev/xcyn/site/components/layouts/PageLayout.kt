package dev.xcyn.site.components.layouts
...
import dev.xcyn.site.components.sections.Footer
import dev.xcyn.site.components.sections.NavHeader
...
fun PageLayout(ctx: PageContext, content: @Composable ColumnScope.() -> Unit) {
    ...
    LaunchedEffect(data.title) {
        document.title = "C's site • ${data.title}"
    }
